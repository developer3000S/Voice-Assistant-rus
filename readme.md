...
### Универсальный личный AI-ассистент
...
> ⚠️ **Примечание по установке:** Если вы получите `ModuleNotFoundError` для ОС-специфичной библиотеки, установите её через `pip install <имя_модуля`. Опциональный движок **слова пробуждения** здесь *не устанавливается* — загрузите одним кликом из **⚙ → СЛОВО ПРОБУЖДЕНИЯ (WAKE WORD )** в приложении.
