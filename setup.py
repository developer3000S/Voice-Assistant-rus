...
packages in requirements.txt carry `sys_platform` Anfisaers, so a macOS or Linux
...
The optional local wake word ("Привет Anfisa") is NOT installed here — it's a
...
def main() -> None:
    ...
    # requirements.txt filters OS-specific extras by itself via pip Anfisaers.
    ...
    print("   3) (Optional) Enable 'Привет Anfisa' from ⚙ → WAKE WORD.")
